...
class CreateSpnCountriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('spn_countries', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement("INSERT INTO spn_countries (id, name, iso3, iso2, phonecode, capital, currency, created_at, updated_at, active_status) VALUES(1, 'Afghanistan', 'AFG', 'AF', '93', 'Kabul', 'AFN', '2018-07-20 14:41:03', '2018-07-20 14:41:03', 1),
    ...
    {
        Schema::dropIfExists('spn_countries');
    }
}
