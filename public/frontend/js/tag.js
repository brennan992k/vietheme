...
/* 
    $(document).ready(function(){ */
        ...
        $(document).on("click","#loadMore",function() {
            //$(this).fadeOut();
            page = page +1 ;            
            AllDataPaginate(newest,bestsell,all,bestrated,trending,high,low,NoSell,LowSell,MediumSell,HighSell,TopSell,star);
        });
