                    ...
                    <div class="single-goods">
                        ...
                        <div class="good-info">
                            ...
                            <div class="goods-prise">
                               ...
                               <br> <a href="#test-form${e.id}" data-toggle="modal" data-target="#myModal${e.id}"  id="AddToCart" > <i class="ti-shopping-cart"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="myModal${e.id}" class="modal fade dm-item-modal" role="dialog">
                     ...
                     <form action="${url+'/item/cart/quick'}" method="post">

                             <input type="hidden"  name="_token" value="${token}">
                             <input type="number" hidden id="id" name="id" value="${e.id}">
                             ...
                             <input type="hidden"  id="license_input${e.id}" name="license_type" value="1">
                             <input type="hidden"  id="support_input${e.id}" name="support_time" value="1">
                                 <div class="row ">
                                     <div class="col-xl-6">
                                     ...
                                     <div class="col-xl-6">
                                             <div class="single_select">
                                                 ...
                                                 <div class="select_box">
                                                         <select class="wide Selectsupport form-control" onChange="calculateHomeItem(${e.id})" id="Selectsupport${e.id}" >
                                                                 <option value="0" id="six" selected data-display="6 months support">6 Months Support</option>
                                                                 <option value="${e.support_fee}" id="twelve">12 Months Support</option>
                                                         </select>
                                                 </div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="content_left">
                                             ...
                                             <div class="content_title">
                                                 <p class="support_text${e.id}">
                                                         <span>License:</span>
                                                         <a href="#" id="license_text${e.id}">Regular</a>
                                                 </p>
                                                 <p class="support_text">
                                                         <span>Support :</span> 
                                                         <small id="support_tym${e.id}">6 Months Support</small>
                                             </p>
                                             </div>
                                         </div>
                                     </div>
...
/* 
    ...
    $(document).ready(function(){ */
      ...
      function calculateHomeItem(id,price) {
        ...
        var license_value=parseFloat(license.options[license.selectedIndex].value).toFixed(2);
            console.log(license_value);
        var support = document.getElementById("Selectsupport"+id);
        var support_value=parseFloat(support.options[support.selectedIndex].value).toFixed(2);
        ...
        document.getElementById("license_text"+id).innerHTML =license.options[license.selectedIndex].text;
        document.getElementById("support_tym"+id).innerHTML =support.options[support.selectedIndex].text;
