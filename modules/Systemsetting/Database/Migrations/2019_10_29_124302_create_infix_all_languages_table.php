...
class CreateInfixAllLanguagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('infix_all_languages', function (Blueprint $table) {
            $table->increments('id');
            $table->string('code');
            $table->string('name');
            $table->string('native');
        ...
        DB::statement("INSERT INTO infix_all_languages (id, code, name, native, rtl) VALUES
    ...
    {
        Schema::dropIfExists('infix_all_languages');
    }
}
