                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @else
                                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'languageAdd', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                            @endif
                            <div class="white-box">
                                    ...
                                    @foreach($sms_languages as $sms_language)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($sms_language->active_status==1)
                                                    <a href="{{URL::to('/systemsetting/change-language/'.$sms_language->id)}}"
                                                ...
                                                <a href="{{url('/')}}/systemsetting/language-setup/{{$sms_language->language_universal}} "
                                                class="primary-btn small tr-bg  "   > <span
                                                        class="ti-settings"></span> @lang('lang.setup') </a>

                                                @if($sms_language->language_universal !='en' && $sms_language->active_status !=1)

                                                <a href="{{url('/')}}/systemsetting/language-delete" class="primary-btn small tr-bg " data-toggle="modal"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ Form::open(['url' => 'systemsetting/language-delete/', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
