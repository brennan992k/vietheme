                                ...
                                @foreach($color_styles as $background_setting)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: {{$background_setting->primary_color}}"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: {{$background_setting->primary_color2}}"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: {{$background_setting->primary_color3}}"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: {{$background_setting->title_color}}"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: {{$background_setting->text_color}}"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: {{$background_setting->sidebar_bg}}"></div>
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            @if($background_setting->is_active==1)
                                                <a class="primary-btn small fix-gr-bg "
                                                   href="#">  @lang('lang.activated') </a>
                                            @else
                                                <a class="primary-btn small tr-bg"
                                                   href="{{route('default_color_theme',$background_setting->id)}}">
