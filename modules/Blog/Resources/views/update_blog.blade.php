    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('lang.update') @lang('lang.blog') </a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(!empty($data['edit']))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'blogUpdate',
                                ...
                                <div class="row mt-40">
                                 ...
                                 <div class="row mt-40">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            <textarea id="editor1" class="primary-input form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="" cols="30" rows="10" data-sample-short>{{isset($data['edit'])? $data['edit']->description:old('description')}}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-effect">
                                             <input class="primary-input form-control{{ $errors->has('tags') ? ' is-invalid' : '' }}" type="text" name="tags"
                                                   id="input-tags" placeholder="Tags" value="{{isset($data['edit'])? $data['edit']->tags :old('tags')}}">
