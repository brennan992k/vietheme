...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.blog') @lang('lang.category') @lang('lang.list')</h1>
            <div class="bc-pages">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($data['edit']) && !empty($data['edit']))
                            <form action="{{ route('update_blog_category')}}"  method="POST" class="form-horizontal" enctype="multipart/form-data" id="addCategory">
                        @else
                            <form action="{{ route ('store_blog_category')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="addCategory">
                        @endif
                            @csrf
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ url('blog/category-edit/'.$item->id)}}">@lang('lang.edit')</a>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                      <a href="{{ route('deleteBlogCategory',$item->id)}}" class="text-light">
