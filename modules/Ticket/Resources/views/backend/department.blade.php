            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($department))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'ticket/department/'.$department->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                        
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'ticket/department',
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{url('ticket/department', [$department->id
                                                    ])}}">@lang('lang.edit')</a>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['url' => 'ticket/department/'.$department->id, 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
