            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'update_kn_base',
                                        ...
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('question') ? ' is-invalid' : '' }}" name="question">
                                                ...
                                                @foreach($data['questions'] as $item)
                                                    <option value="{{$item->id}}" {{ @$data['edit']->question_id ==$item->id ?'selected':""}} >{{$item->first_question}}</option>
                                                 @endforeach
                                            </select>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('sub_question') ? ' is-invalid' : '' }}" type="text" name="sub_question"
                                                   autocomplete="off" value="{{isset($data['edit'])? $data['edit']->sub_question :old('sub_question')}}">
                                 ...
                                 <div class="row mt-40">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            <textarea id="editor1" class="primary-input form-control{{ $errors->has('answer') ? ' is-invalid' : '' }}" name="answer" id="" cols="30" rows="10" data-sample-short>{{isset($data['edit'])? $data['edit']->answer :old('answer')}}</textarea>
                                            <span class="focus-border"></span>
