            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($data['edit']) && !empty($data['edit']))
                            <form action="{{ route('update_knowledge_base_category')}}"  method="POST" class="form-horizontal" enctype="multipart/form-data" id="addCategory">
                        @else
                            <form action="{{ route ('store_knowledge_base_category')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="addCategory">
                        @endif
                            @csrf
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status">
                                                ...
                                                <option value="1" {{ @$data['edit']->active_status ==1 ?'selected':""}}>@lang('lang.active')</option>
                                                <option value="2" {{ @$data['edit']->active_status ==2 ?'selected':""}}>@lang('lang.inactive')</option>
                                            </select>
                                            <span class="focus-border"></span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($data['knowledge_categories'] as $item)
                                <tr>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ url('knowledgebase/category-edit/'.$item->id)}}">@lang('lang.edit')</a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center">
                                                    {{-- <p class="text-danger">@lang('lang.deleteWarning') </p> --}}
                                                    <h4>@lang('lang.are_you_sure_to_delete')</h4>
                                                </div>

                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                      <a href="{{ route('deleteKnowledgeBaseCategory',$item->id)}}" class="text-light">
