...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.terms') @lang('lang.conditions')</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.frontend_CMS') </a>
                <a href="#">@lang('lang.terms') @lang('lang.&') @lang('lang.conditions') </a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"> @lang('lang.update')
                                @lang('lang.terms') @lang('lang.&') @lang('lang.conditions')
                            </h3>
                        </div>
                      
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'terms-conditions-update',
