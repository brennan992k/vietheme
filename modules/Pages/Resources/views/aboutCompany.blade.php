...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.about') @lang('lang.company')</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.frontend_CMS') </a>
                <a href="#">@lang('lang.about') @lang('lang.company') </a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"> @lang('lang.update')
                                @lang('lang.about') @lang('lang.company')
                            </h3>
                        </div>
                      
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'about-company-update',
                        ...
                        <div class="white-box">
                            ...
                            <div class="add-visitor">  
                                    ...
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('heading_title') ? ' is-invalid' : '' }}"
                                                type="text" name="heading_title" autocomplete="off" value="{{isset($editData)? $editData->heading_title:old('heading_title')}}">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.sub') @lang('lang.title') <span class="text-red">*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            <textarea name="short_description" class="primary-input form-control{{ $errors->has('short_description') ? ' is-invalid' : '' }}" rows="5">{{isset($editData)? $editData->short_description:old('short_description')}}</textarea> 
                                            <label>@lang('lang.short') @lang('lang.description') <span class="text-red">*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40"> 
                                    <div class="col-lg-12">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input" type="text" id="placeholderPhoto" placeholder="{{@$image[array_key_last ($image)]}}" readonly="">
                                                    <span class="focus-border"></span>
                                                </div>
                                            </div>
                                            <div class="col-auto">
