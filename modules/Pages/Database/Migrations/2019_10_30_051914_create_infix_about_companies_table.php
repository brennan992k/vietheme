...
class CreateInfixAboutCompaniesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('infix_about_companies', function (Blueprint $table) {
            $table->increments('id');
        ...
        DB::table('infix_about_companies')->insert(
            [
    ...
    {
        Schema::dropIfExists('infix_about_companies');
    }
}
