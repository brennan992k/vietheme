...
class CreateInfixTermsConditionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('infix_terms_conditions', function (Blueprint $table) {
            $table->increments('id');
        ...
        DB::table('infix_terms_conditions')->insert(
            [
                'heading_title'       => 'Terms Conditions',
    ...
    {
        Schema::dropIfExists('infix_terms_conditions');
    }
}
