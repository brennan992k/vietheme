    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="{{url('humanresource/department-add')}}" class="primary-btn small fix-gr-bg">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($department))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'humanresource/department->update/'.$department->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                         @if(Auth::user()->role_id == 1 )
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'humanresource/department-store',
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{url('humanresource/department-edit', [$department->id
                                                    ])}}">@lang('lang.edit')</a>
                                               @endif
                                               @if(Auth::user()->role_id == 1 )
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['url' => 'humanresource/department/'.$department->id, 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
