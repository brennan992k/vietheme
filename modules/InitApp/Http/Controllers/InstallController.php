...
use Modules\InitApp\Http\Requests\DatabaseRequest;
use Modules\InitApp\Http\Requests\LicenseRequest;
use Modules\InitApp\Http\Requests\ModuleInstallRequest;
...
class InstallController extends Controller
{
    ...
    public function __construct(InstallServiceRepository $repo, Request $request)
    {
        $this->repo = $repo;
