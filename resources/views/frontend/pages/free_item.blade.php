                                            ...
                                            <div class="catagori-submenu-inner">
                                                ...
                                                <div class="catagori-content">
                                                    <ul>
                                                        ...
                                                        @if (@$cat_count[$val['id']] > 0)                                                            
                                                           <li><a href="{{ route('searchCategoryItem',strtolower(str_replace(' ', '_',@$val['name']))) }}">{{ @$val['name'] }} <span> ({{ @$cat_count[$val['id']] }}) </span></a></li>
                                                        @endif                                                       
                                                        @endforeach
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="catagori-submenu-inner">
                                                ...
                                                <div class="catagori-content">
                                                    <ul>                                  
                                                         ...
                                                         @endphp 
                                                             @if (@$val && @$number > 0) 
                                                               <li><a href="{{ @$data['sub_cat']? route('tagSubItem',[@$data['category']->slug,@$data['sub_cat']->slug,'tag',strtolower(str_replace(' ', '_',@$val))]) : route('tagCatItem',[@$_cat_slug->slug,'tags',strtolower(str_replace(' ', '_',@$val))])}}">{{@$val}}<span> ({{ @$number }})</span></a></li>                                                        
                                                             @endif
                                                             @endforeach
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="catagori-submenu-area">
                                            <div class="catagori-submenu-inner">
                                                ...
                                                <div class="catagori-content">
                                                    ...
                                                    <ul>
                                                        <li><a href="{{ @$data['category']? route('tagCatItem',[@$data['category']->slug,'date','anydate']) : route('dateItem',['date','anydate'])}}">@lang('lang.any') @lang('lang.date')<span> ( {{$data['Any_Date']}} )</span></a></li>
                                                        <li><a href="{{ @$data['category']? route('tagCatItem',[@$data['category']->slug,'date','last_year']) : route('dateItem',['date','last_year'])}}">@lang('lang.in_the_last') @lang('lang.year') <span> ({{ $data['LastYear'] }})</span></a></li>
                                                        <li><a href="{{ @$data['category']? route('tagCatItem',[@$data['category']->slug,'date','last_month']) : route('dateItem',['date','last_month'])}}">@lang('lang.in_the_last') @lang('lang.month') <span> ({{ $data['Last_month']}})</span></a></li>
                                                        <li><a href="{{ @$data['category']? route('tagCatItem',[@$data['category']->slug,'date','last_week']) : route('dateItem',['date','last_week'])}}">@lang('lang.in_the_last') @lang('lang.week')<span> ({{$data['Last_week']}})</span></a></li>
                                                        <li><a href="{{ @$data['category']? route('tagCatItem',[@$data['category']->slug,'date','last_day']) : route('dateItem',['date','last_day'])}}">@lang('lang.in_the_last') @lang('lang.day')<span> ({{$data['Last_day']}})</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
@endsection
@push('js')
<script src="{{ asset('public/frontend/js/') }}/free_item.js"></script>
