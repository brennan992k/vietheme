...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.payment') @lang('lang.method') @lang('lang.view')</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.payment') @lang('lang.method') @lang('lang.view')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
         <div class="col-lg-3">
            ...
            <div class="main-title">
                <h3 class="mb-20">@lang('lang.payment') @lang('lang.method') @lang('lang.view')</h3>
            </div>
            ...
            <div class="col-lg-9 staff-details">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#Earning" role="tab" data-toggle="tab">@lang('lang.payment') @lang('lang.method')</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade show active" id="Earning">
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            @if(isset($data)){{@$data->card_name}}@endif
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-40">
                                    ...
                                    <a href="{{ route('admin.paymentMethodApprove',@$data->id) }}" class="primary-btn fix-gr-bg">
