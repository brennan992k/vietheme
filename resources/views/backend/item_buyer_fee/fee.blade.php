    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{ route('admin.fee')}}" class="active"> @lang('lang.fee') @lang('lang.list')</a>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($data['edit']) && !empty(@$data['edit']))
                            <form action="{{url('admin/buyer-item-fee-update')}}"  method="POST" class="form-horizontal" enctype="multipart/form-data" id="addfee">
                        @else
                            <form action="{{url('admin/buyer-item-fee-store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="addfee">
                        @endif
                            @csrf
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}"
                                                            name="user_id">
                                                        <option data-display="@lang('lang.vendor')"
                                                                value="">@lang('lang.vendor') @lang('lang.list') 
                                                        </option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('type') ? ' is-invalid' : '' }}" name="type">
                                                ...
                                                <option value="1" {{isset($data['edit'])? $data['edit']->type == 1?'selected':'': ''}} >@lang('lang.regular_buyer_Fee')</option> 
                                                <option value="2" {{isset($data['edit'])? $data['edit']->type == 2?'selected':'': ''}}>@lang('lang.extend_buyer_Fee')</option> 
                                            </select>
                                            <span class="focus-border"></span>
                                            @if ($errors->has('type'))
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.fee') @lang('lang.list')</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">
                                        @if (@$item->type == 1)
                                        @lang('lang.regular_buyer_Fee')
                                        @else   
                                        @lang('lang.extend_buyer_Fee')
                                        @endif
                                    </td>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{url('admin/buyer-item-fee-edit/'.@$item->id)}}">@lang('lang.edit')</a>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                      <a href="{{ route('admin.deletebuyerItemFee',@$item->id)}}" class="text-light">
