...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.buyer') @lang('lang.fee') @lang('lang.type') @lang('lang.list')</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="{{ route('admin.fee_type')}}" class="active">@lang('lang.buyer') @lang('lang.fee') @lang('lang.type') @lang('lang.list')</a>
                @if(isset($data['edit']) && !empty(@$data['edit']))
                <a href="#" class="active">@lang('lang.buyer') @lang('lang.fee') @lang('lang.edit')</a>
            @endif
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="{{route('admin.fee_type')}}" class="primary-btn small fix-gr-bg">
                        ...
                        <div class="main-title">
                            <h3 class="mb-30">
                                ...
                                @else
                                    @lang('lang.add')
                                @endif
                                @lang('lang.buyer')  @lang('lang.fee')  @lang('lang.type')
                            </h3>
                        </div>
                        @if(isset($data['edit']) && !empty(@$data['edit']))
                            <form action="{{url('admin/fee-type-update')}}"  method="POST" class="form-horizontal" enctype="multipart/form-data" id="addfee">
                        @else
                            <form action="{{url('admin/fee-type-store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="addfee">
                        @endif
                            @csrf
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.buyer')  @lang('lang.fee')  @lang('lang.type')</h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{url('admin/fee-type-edit/'.@$item->id)}}">@lang('lang.edit')</a>
                                                @if (@$item->slug != 'extend_support_fee')                                                    
                                                <a class="dropdown-item" data-toggle="modal" data-target="#deleteClassModal{{@$item->id}}" >@lang('lang.delete')</a>
                                                @else
                                                <a class="dropdown-item" data-toggle="tooltip" data-placement="top" title="You can not delete!" >@lang('lang.delete')</a>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                      <a href="{{ route('admin.deletefee_type',$item->id)}}" class="text-light">
