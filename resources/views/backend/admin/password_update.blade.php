        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="white-box">
					...
					@else
						{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'admin.password_update', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                 	 @endif  
										...
										<div class="row mb-25">
											...
											<div class="row">
												<div class="col-lg-12 mt-20 text-center">  
														...
														<button   class="primary-btn small fix-gr-bg  demo_view password_update_btn" type="button" > @lang('lang.change') @lang('lang.password')</button>
														</span>
													@else
