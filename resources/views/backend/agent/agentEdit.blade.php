...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.agent') @lang('lang.edit')</h1>
            <div class="bc-pages">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.agent') @lang('lang.edit')</h3>
                </div>
            </div>
        </div>
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['admin.agent_update',@$data->id], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' =>'profile']) }}
        <div class="row">
            <div class="col-lg-12">
              <div class="white-box">
                <div class="">
                    ...
                    <input type="hidden" name="staff_id" value="{{@$data->id}}"> 
                            <div class="row mb-30 mt-20">
                                    ...
                                    <div class="col-lg-6 mt-20">
                                        <div class="input-effect">
                                            <textarea class="primary-input form-control {{ $errors->has('address') ? 'is-invalid' : ''}}" cols="0" rows="4" name="address" id="address">{{ (isset($data->profile->address)) ? $data->profile->address : old('address') }}</textarea>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn fix-gr-bg">
                                    ...
                                    @lang('lang.agent') @lang('lang.update')
                                </button>
                            </div>
                        </div>
</div>
