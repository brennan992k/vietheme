...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.author') @lang('lang.edit')</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="{{route('admin.vendor')}}">@lang('lang.author') @lang('lang.list')</a>
                <a href="#">@lang('lang.author') @lang('lang.edit')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.author') @lang('lang.edit')</h3>
                </div>
            </div>
        </div>
        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['admin.vendor_update',@$data->id], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' =>'profile']) }}
        <div class="row">
            <div class="col-lg-12">
              <div class="white-box">
                <div class="">
                    ...
                    <div class="row mb-30 mt-20">
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <input class="primary-input form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" type="text"  name="username" readonly value="@if(isset($data)){{@$data->username}} @endif">
                                    ...
                                    <div class="col-lg-4 mt-40">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control" name="marital_status">
                                                ...
                                                <option value="married" {{@$data->profile->marital_status == "married"? 'selected':''}}>@lang('lang.married')</option>
                                                <option value="unmarried" {{@$data->profile->marital_status == "unmarried"? 'selected':''}}>@lang('lang.unmarried')</option>
                                            ...
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input form-control {{ $errors->has('image') ? ' is-invalid' : '' }}" type="text"
                                                          id="placeholderPhoto" 
                                                           placeholder="{{@$data->profile->image != ""? showPicName(@$data->profile->image):'Profile Photo (100 * 100 px)'}}"
                                                           readonly="">
                                                    <span class="focus-border"></span>
                                                    @if ($errors->has('image'))
                                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row mt-40">
                                <div class="col-lg-12 text-center">
                                    <button class="primary-btn fix-gr-bg">
                                        ...
                                        @lang('lang.author') @lang('lang.update')
                                    </button>
                                </div>
                            </div>
