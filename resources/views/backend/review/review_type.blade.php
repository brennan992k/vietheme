...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.review') @lang('lang.type') @lang('lang.list')</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="{{ route('admin.review_type')}}" class="active">@lang('lang.review') @lang('lang.type') @lang('lang.list')</a>
                @if(isset($data['edit']) && !empty(@$data['edit']))
                <a href="#" class="active">@lang('lang.review') @lang('lang.edit')</a>
            @endif
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="{{route('admin.review_type')}}" class="primary-btn small fix-gr-bg">
                        ...
                        <div class="main-title">
                            <h3 class="mb-30">
                                ...
                                @else
                                    @lang('lang.add')
                                @endif
                                 @lang('lang.review')  @lang('lang.type')
                            </h3>
                        </div>
                        @if(isset($data['edit']) && !empty(@$data['edit']))
                            <form action="{{url('admin/review-type-update')}}"  method="POST" class="form-horizontal" enctype="multipart/form-data" id="addreview">
                        @else
                            <form action="{{url('admin/review-type-store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="addfee">
                        @endif
                            @csrf
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title lm_mb_35 sm_mb_20 ">
                            <h3 class="mb-0">@lang('lang.review')  @lang('lang.type')</h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{url('admin/review-type-edit/'.@$item->id)}}">@lang('lang.edit')</a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('lang.delete') @lang('lang.review')</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                      <a href="{{ route('admin.deletereview_type',@$item->id)}}" class="text-light">
