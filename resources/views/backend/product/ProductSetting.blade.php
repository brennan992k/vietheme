    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.product') @lang('lang.setting')</h1>
                <div class="bc-pages">
                    <a href="{{route('admin.dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="#" class="active">@lang('lang.product') @lang('lang.setting')</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="main-title">
                                <h3 class="mb-30">
                                    ...
                                    @else
                                        @lang('lang.add')
                                    @endif
                                    @lang('lang.product') @lang('lang.setting')
                                </h3>
                            </div>
                            @if(isset($data['edit']) && !empty(@$data['edit']))
                                <form action="{{url('admin/product-setting-update')}}" method="POST"
                                      class="form-horizontal" enctype="multipart/form-data">
                                    @else
                                        <form action="{{url('admin/product-setting-store')}}" method="POST"
                                              class="form-horizontal" enctype="multipart/form-data">
                                            @endif
                                            @csrf
                                            ...
                                            <div class="white-box">
                                                <div class="add-visitor">
                                                    ...
                                                    <div class="row mt-25">
                                                        <div class="col-lg-12">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control{{ $errors->has('url') ? ' is-invalid' : '' }}"
                                                                       type="text" name="url" autocomplete="off"
                                                                       value="{{isset($data['edit'])? $data['edit']->title:old('url')}}">

                                                                <input type="hidden" name="id"
                                                                       value="{{isset($data['edit'])? $data['edit']->id: ''}}">
                                                                <label>@lang('lang.url') </label>
                                                                <span class="focus-border"></span>
                                                                @if ($errors->has('url'))
                                                                    <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}"
                                                                       type="number" step="any" name="amount" autocomplete="off"
                                                                       value="{{isset($data['edit'])? $data['edit']->title:old('amount')}}">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0">@lang('lang.product') @lang('lang.setting')</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                @foreach($data['ProductSetting'] as $item)
                                    <tr>
                                        <td valign="top">{{@$item->title}}</td>
                                        <td valign="top">{{@$item->category->title}}</td>
                                        <td valign="top">{{@$item->amount}}</td>
                                        <td valign="top"><a class="primary-btn fix-gr-bg small" href="{{@$item->url}}" target="_blank">view</a> </td>
                                        <td valign="top">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{ route('admin.ProductSettingEdit',@$item->id)}}">@lang('lang.edit')</a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">@lang('lang.delete')@lang('lang.product') @lang('lang.setting')</h4>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        <a href="{{ route('admin.ProductSettingDelete',@$item->id)}}" class="text-light">
                                                            <button class="primary-btn fix-gr-bg"
