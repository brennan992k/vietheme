...
<head>
    ...
    <title>InfixHub - Digital Marketplace</title>
        ...
        <div class="card">
            <div class="single-report-admit">
                <div class="card-header installation_home">
                    <h2 class="text-center text-uppercase dm_title_color title">Welcome To InfixHub - Digital Marketplace</h2>
                </div>
            </div>
            <div class="card-body">
                <p class="dm_text_center">Thank you for choosing InfixHub - Digital Marketplace for your Digital Marketplace administration.<br>Please follow the steps to complete InfixHub - Digital Marketplace installation!</p>
               <a href="{{url('/check-purchase-verification')}}"  class="offset-3 col-sm-6 primary-btn fix-gr-bg mt-40 mb-20"  > Let's Start </a>
            </div>
        </div>
    </div>
