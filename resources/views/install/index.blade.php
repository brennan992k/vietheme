        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase dm_title_color">Welcome to InfixHub Digital Market Place </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p class="dm_text_center">Thank you for choosing InfixHub Digital Market Place for your market palce administration. Please follow the steps to complete Infix Digital Market Place installation!</p>
