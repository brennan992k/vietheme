        ...
        <td>
            <table style="border: 1px solid #f1f1f1; border-collapse: collapse;" border="0" max-width="600" align="center" bgcolor="#fff">
                <tbody >
                    ...
                    {{-- <p style="font-style: italic;text-align: center"><font color="white">{{ env('APP_NAME') }}</font></p> --}}
                    </td>
                    <tr>
                        ...
                        <b>Hi, {{@$data['receiver_info']->full_name}}</b>
                            <br />
                            <p>
                                <br />
                                Your Bank deposit request form {{GeneralSetting()->currency_symbol}}{{@$data['fund_info']->amount}} has been approved by authority
                                {{-- You have received {{@$fund_info->amount}}{{GeneralSetting()->currency_symbol}} from Superadmin --}}
                            </p>
                        </td>
                    </tr>
                    <tr>
